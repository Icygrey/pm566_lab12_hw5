...
# Data & API
 ...
 LA_raw_crime：The API comes from Los Angeles city data. The data collection includes all data from January 2020 to October 7, 2020. (https://data.lacity.org/resource/2nrs-mtv8.json)
